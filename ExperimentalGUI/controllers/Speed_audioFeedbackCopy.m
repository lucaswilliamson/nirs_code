...
%             end
            ...
            for l=1
                ...
                if body_y_pos(frameind.Value) > y_min && body_y_pos(frameind.Value) < y_max && framenum.Value-HS_frame>pad
                    ...
                    %straightaways
                    if nirs
                        if body_y_pos_diff(frameind.Value) >= y_min_straight && rightout1 ~= 1
                            rightout1 = 1;
                            tright1 = clock;
                        elseif body_y_pos_diff(frameind.Value) >= y_max_straight && rightout2 ~= 1
                            rightout2 = 1;
                            tright2 = clock;
                        elseif body_y_pos_diff(frameind.Value) <= y_max_straight && rightout2 == 1
                            leftout1 = 1;
                            tleft1 = clock;
                        elseif body_y_pos_diff(frameind.Value) <= y_min_straight && rightout2 == 1
                            leftout2 = 1;
                            tleft2 = clock;
                        end
                    end
                    ...
                    if nirs
                        if rightout1 == 1 && rightout2 == 1 && rightout3 ~= 1 %end of right straightaway; by the door
                            ...
                            straight_duration = abs((ts_diff(4)*3600)+(ts_diff(5)*60)+ts_diff(6));
                            rightout3 = 1;
                            datlog.straightTime(end+1) = straight_duration;

                        elseif tleft1 == 1 && tleft2 == 1 %end of left straightaway; by the computer
